...
- Show/Hide the cooldowns bars -> **by default the bars will be hidden during pet battles.** This option can only be set to on or off during pet battles, but it will keep using the setting you have set for this.
