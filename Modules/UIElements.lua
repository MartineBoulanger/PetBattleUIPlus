...
function addon.UIElements.ToggleBags(shouldHide)
  if InCombatLockdown() then
      print("|cffC41E3APet Battle UI Plus: Cannot toggle bags during combat.|r")
      return
  end
  ...
  C_Timer.After(0.1, function()
      if C_PetBattles.IsInBattle() then
          ...
          print("|cff00F300Pet Battle UI Plus: Bags are now " .. (shouldHide and "hidden." or "visible.") .. "|r")
      else
          print("|cffC41E3APet Battle UI Plus: Cannot toggle bags, you are not in a pet battle.|r")
      end
  end)
end
